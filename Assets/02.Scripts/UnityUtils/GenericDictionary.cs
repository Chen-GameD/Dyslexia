...
namespace EAUtils {
	...
	public class GenericDictionary<TKey, TValue>: IDictionary<TKey, TValue>, ISerializationCallbackReceiver {
		// Internal
		[SerializeField, OneLine] List<KeyValuePair> list = new List<KeyValuePair>();
		[SerializeField] Dictionary<TKey, int> indexByKey = new Dictionary<TKey, int>();
		[SerializeField, HideInInspector] Dictionary<TKey, TValue> dict = new Dictionary<TKey, TValue>();
